...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # First image
        img=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Left logo.jpeg")
        ...
        # Second image
        img1=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\center.jpeg")
        ...
        # Third image
        img2=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Right logo.jpeg")
        ...
        # Student Button
        img4=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Student Details.jpeg")
        ...
        # Detect Face button
        img5=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Face Recognition.jpg")
        ...
        b1_1.place(x=500,y=300,width=220,height=40)
         ...
         # Attendance button
        img6=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Attendence.jpeg")
        ...
        # Help Desk
        img7=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Chatbot.jpeg")
        ...
        b1_1.place(x=1100,y=300,width=220,height=40)
         ...
         # Train data Face
        img8=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Train Data.jpeg")
        ...
        # Photos
        img9=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Photos.jpeg")
        ...
        # Developer
        img10=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Developer.jpeg")
        ...
        # Exit
        img11=Image.open(r"Face Recognition Attendence system(FRAS)\face photo\Exit.jpeg")
